...
<div class="container-fluid disable-text-selection">
  <div class="row">
    ...
    <div class="col-12">
      <div class="mb-2">
        <h1>Nouveau Retour du commande N° <?php echo $id ?></h1>
        <div class="float-sm-right text-zero">
          <button type="button" class="btn btn-primary btn-lg  mr-1 url notlink" data-url="retour/add.php?id=<?php echo $id ?>">AJOUTER</button>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        $('body').on("click", ".delete", function(event) {
          ...
          swal({
            title: 'Êtes-vous sûr?',
            text: "Voulez vous vraiment Supprimer ce retour !",
            type: 'warning',
