  ...
  <div class="container-fluid disable-text-selection">
    <div class="row">
      <div class="col-12">
        <div class="mb-2">
          <h1>Nouveau Retour commande N&deg; : <?php echo $id ?> </h1>

          <div class="float-sm-right text-zero">
            <button type="button" class="btn btn-success  url notlink" data-url="retour/index.php?id=<?php echo $id ?>"> <i class="glyph-icon simple-icon-arrow-left"></i></button>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col align-self-start">
        <div class="card mb-4">
          <div class="card-body">
            <h5 class="mb-4">Ajouter Nouveau Retour</h5>
