...
<table>
   ...
   <tr>
      <td width="24%" style="height:10; width:10%;">Date</td>
      <td width="4%"> : </td>
      <td> CASABLANCA Le ' . date('d/m/Y',strtotime($vente1["date_vente"]))  . '</td>
   </tr>
...
$pdf->setCellPadding(3,0,3,0 );
$pdf->SetFont('dejavusans', '', 7, '', true);
$pdf->writeHTMLCell(86, 20,'','', '', 0, 1 , 'C',0);   
...
<table cellspacing="0" cellpadding="3" border="1" class="mytable">
 <tr style="background-color:#2597d5;">
       <th  align="center" height="10" width="6%" style="color:white; font-weight:800; font-size:8.5pt;">N°</th>
        <th  align="center" height="10" width="65%" style="color:white; font-weight:800; font-size:8.5pt;">Désignation</th>
...
<table cellspacing="0" cellpadding="3" border="1" class="mytable">
 <tr style="background-color:#2597d5;">
       <th  align="center" height="10" width="6%" style="color:white; font-weight:800; font-size:8.5pt;">N°</th>
        <th  align="center" height="10" width="48%" style="color:white; font-weight:800; font-size:8.5pt;">Désignation</th>
        <th  height="10" width="15%" style="color:white; font-weight:800; font-size:8.5pt;text-align:right;">Prix</th>
        <th  align="center" height="10" width="15%" style="color:white; font-weight:800; font-size:8.5pt;">Qte</th>
        <th  align="center" height="10" width="15%" style="color:white; font-weight:800; font-size:8.5pt;">montant total</th>
</tr>
  ';
...
(  (($ligne["qte_vendu"]*$ligne["prix_produit"] ) - (($ligne["qte_vendu"]*$ligne["prix_produit"] ) * ($ligne["remise"]/100)) ) * $ligne["tva"] ) ;
  ...
  $tbl1.= '<tr>
        ...
        <td align="right">'.number_format($ligne['qte_vendu'],2,"."," ").'</td>
        <td align="right">'.number_format($ligne['qte_vendu']  * $ligne['prix_produit'],2,"."," ").'</td>
    </tr>';
...
<table cellspacing="0" cellpadding="6"   class="tab-foot" width="100%">
    ...
    <th align="center" height="10" width="40%"></th>
      <th border="1" align="center" height="10" width="20%" style="background-color:#2597d5;color:white">TOTAL</th>
    </tr>
     <tr>
     <td align="center"  ></td>
     <td align="center"  ></td>
