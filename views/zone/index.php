    ...
    <div class="col-12">
      <div class="mb-2">
        ...
        <div class="float-sm-right text-zero">
          <button type="button" class="btn btn-primary btn-lg  mr-1 url notlink" data-url="zone/add.php" >AJOUTER</button>
        </div>
        ...
        <div class="card-body">
          ...
          <table class="table  responsive table-striped table-bordered table-hover" style="width: 60%" id="datatables" >
            ...
            <tbody>
              ...
              ?>
              <tr>
                <td> <?php echo $ligne->id_zone ; ?></td>
                <td> <?php echo $ligne->libelle ; ?> </td>
                <td>
                  <?php if(auth::user()['privilege'] == 'Admin') { ?>
                  <a class="badge badge-danger mb-2 delete" data-id="<?php echo $ligne->id_zone; ?>" style="color: white;cursor: pointer;" title="Supprimer" href='javascript:void(0)' >
                    <i class="simple-icon-trash" style="font-size: 15px;"></i>
                  </a>
                  <?php } ?>
                  <?php if(auth::user()['privilege'] == 'Admin' || auth::user()['privilege'] == 'User+'){ ?>
                  <a class="badge badge-warning mb-2  url notlink" data-url="zone/update.php?id=<?php echo $ligne->id_zone; ?>" style="color: white;cursor: pointer;" title="Modifier"
           ...
           $('#datatables').dataTable({
            ...
            $('body').on( "click",".delete", function( event ) {
             event.preventDefault();
                ...
                swal({
                 title: 'Êtes-vous sûr?',
                  text: "Voulez vous vraiment Supprimer cet zone !",
                  type: 'warning',
