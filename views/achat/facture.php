...
$pdf->Cell(25,$height,number_format($prix,6,"."," "),'BR',0,'R',0);
$pdf->Cell(30,$height,number_format($prix*$ligne["qte_achete"],6,"."," "),'RB',1,'R',0);
...
$pdf->SetFont('dejavusans', '', 9, '', true);
$pdf->Cell(55,5,number_format($totalht,6,"."," ") . ' DH',1,1,'R',0);
$pdf->Cell(100);
$pdf->Ln(5);
$pdf->Cell(10);
