                      ...
                      <form id="addform" method="post" name="form_utilisateur" enctype="multipart/form-data">
                          ...
                          <div class="form-row">
                              ...
                              <div class="form-group col-md-4 client">
                                  ...
                                  <input type="text" class="form-control" id="tele" name="tele" value="<?php echo $oldvalue['tele']; ?>">
                              </div>
                              <div class="form-group col-md-4 client">
                          ...
                          <div class="form-row">
                              <div class="form-group col-md-4">
                                  ...
                                  <input type="text" class="form-control" id="login" name="login" value="<?php echo $oldvalue['login']; ?>">
                              </div>
                              <div class="form-group col-md-4">
                                  <label for="pwd">Password :</label>
                                  <input type="text" class="form-control" id="pwd" name="pwd" value="<?php echo $oldvalue['pwd']; ?>">
                              </div>
                              <div class="form-group col-md-4">
                                  <label for="nom_prenom_ar">Privilege :</label>
                                  <select <?php auth::user()['privilege'] !== "Admin" ? print 'disabled' : '' ?> class="form-control" name="privilege">
                                      <option <?php $oldvalue['privilege'] == "Admin" ? print 'selected' : '' ?> value="Admin"> Admin</option>
                                      <option <?php $oldvalue['privilege'] == "Vendeur" ? print 'selected' : '' ?> value="Vendeur">Vendeur</option>
                                      <option <?php $oldvalue['privilege'] == "User+" ? print 'selected' : '' ?> value="User+"> User+</option>
                                      <option <?php $oldvalue['privilege'] == "User" ? print 'selected' : '' ?> value="User"> User</option>
                                  </select>
                              </div>
                              <div class="form-group col-md-4">
                            ...
                            <h1>Priviléges Opérations</h1>
                              <div class="form-row">
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          ...
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['client'] == 0 ? print 'checked' : '' ?> type="radio" id="client2" value="0" name="client" class="custom-control-input">
                                  ...
                                  <!-- <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input type="radio" id="zone1" value="1" <?php $oldvalue['zone'] == 1 ? print 'checked' : '' ?> name="zone" class="custom-control-input">
                                              <label class="custom-control-label" for="zone1">oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['zone'] == 0 ? print 'checked' : '' ?> type="radio" id="zone2" value="0" name="zone" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['achat'] == 1 ? print 'checked' : '' ?> type="radio" id="achat1" value="1" name="achat" class="custom-control-input">
                                              <label class="custom-control-label" for="achat1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['achat'] == 0 ? print 'checked' : '' ?> type="radio" id="achat2" value="0" name="achat" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          ...
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['vente'] == 0 ? print 'checked' : '' ?> type="radio" id="vente2" value="0" name="vente" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['produit'] == 1 ? print 'checked' : '' ?> type="radio" id="produit1" value="1" name="produit" class="custom-control-input">
                                              <label class="custom-control-label" for="produit1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['produit'] == 0 ? print 'checked' : '' ?> type="radio" id="produit2" value="0" name="produit" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['avoir'] == 1 ? print 'checked' : '' ?> type="radio" id="avoir1" value="1" checked="" name="avoir" class="custom-control-input">
                                              <label class="custom-control-label" for="avoir1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['avoir'] == 0 ? print 'checked' : '' ?> type="radio" id="avoir2" value="0" name="avoir" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['charge'] == 1 ? print 'checked' : '' ?> type="radio" id="charge1" value="1" checked="" name="charge" class="custom-control-input">
                                              <label class="custom-control-label" for="charge1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['charge'] == 0 ? print 'checked' : '' ?> type="radio" id="charge2" value="0" name="charge" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['depot'] == 1 ? print 'checked' : '' ?> type="radio" id="depot1" value="1" checked="" name="depot" class="custom-control-input">
                                              <label class="custom-control-label" for="depot1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['depot'] == 0 ? print 'checked' : '' ?> type="radio" id="depot2" value="0"  name="depot" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['ancienne_vente'] == 1 ? print 'checked' : '' ?> type="radio" id="ancienne_vente1" value="1" checked="" name="ancienne_vente" class="custom-control-input">
                                              <label class="custom-control-label" for="ancienne_vente1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['ancienne_vente'] == 0 ? print 'checked' : '' ?> type="radio" id="ancienne_vente2" value="0"  name="ancienne_vente" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['devis'] == 1 ? print 'checked' : '' ?> type="radio" id="devis1" value="1" checked="" name="devis" class="custom-control-input">
                                              <label class="custom-control-label" for="devis1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['devis'] == 0 ? print 'checked' : '' ?> type="radio" id="devis2" value="0"  name="devis" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['achat_vente'] == 1 ? print 'checked' : '' ?> type="radio" id="achat_vente1" value="1" checked="" name="achat_vente" class="custom-control-input">
                                              <label class="custom-control-label" for="achat_vente1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['achat_vente'] == 0 ? print 'checked' : '' ?> type="radio" id="achat_vente2" value="0"  name="achat_vente" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['bon_commande'] == 1 ? print 'checked' : '' ?> type="radio" id="bon_commande1" value="1" checked="" name="bon_commande" class="custom-control-input">
                                              <label class="custom-control-label" for="bon_commande1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['bon_commande'] == 0 ? print 'checked' : '' ?> type="radio" id="bon_commande2" value="0"  name="bon_commande" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['commande_vendeur'] == 1 ? print 'checked' : '' ?> type="radio" id="commande_vendeur1" value="1" checked="" name="commande_vendeur" class="custom-control-input">
                                              <label class="custom-control-label" for="commande_vendeur1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['commande_vendeur'] == 0 ? print 'checked' : '' ?> type="radio" id="commande_vendeur2" value="0"  name="commande_vendeur" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['bon_livraison'] == 1 ? print 'checked' : '' ?> type="radio" id="bon_livraison1" value="1" checked="" name="bon_livraison" class="custom-control-input">
                                              <label class="custom-control-label" for="bon_livraison1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['bon_livraison'] == 0 ? print 'checked' : '' ?> type="radio" id="bon_livraison2" value="0"  name="bon_livraison" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['reglement'] == 1 ? print 'checked' : '' ?> type="radio" id="reglement1" value="1" checked="" name="reglement" class="custom-control-input">
                                              <label class="custom-control-label" for="reglement1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['reglement'] == 0 ? print 'checked' : '' ?> type="radio" id="reglement2" value="0"  name="reglement" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['facture'] == 1 ? print 'checked' : '' ?> type="radio" id="facture1" value="1" checked="" name="facture" class="custom-control-input">
                                              <label class="custom-control-label" for="facture1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['facture'] == 0 ? print 'checked' : '' ?> type="radio" id="facture2" value="0"  name="facture" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['caisse'] == 1 ? print 'checked' : '' ?> type="radio" id="caisse1" value="1" checked="" name="caisse" class="custom-control-input">
                                              <label class="custom-control-label" for="caisse1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['caisse'] == 0 ? print 'checked' : '' ?> type="radio" id="caisse2" value="0"  name="caisse" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['transfert_caisse'] == 1 ? print 'checked' : '' ?> type="radio" id="transfert_caisse1" value="1" checked="" name="transfert_caisse" class="custom-control-input">
                                              <label class="custom-control-label" for="transfert_caisse1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['transfert_caisse'] == 0 ? print 'checked' : '' ?> type="radio" id="transfert_caisse2" value="0"  name="transfert_caisse" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['recette_point_vente'] == 1 ? print 'checked' : '' ?> type="radio" id="recette_point_vente1" value="1" checked="" name="recette_point_vente" class="custom-control-input">
                                              <label class="custom-control-label" for="recette_point_vente1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['recette_point_vente'] == 0 ? print 'checked' : '' ?> type="radio" id="recette_point_vente2" value="0"  name="recette_point_vente" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['annulation'] == 1 ? print 'checked' : '' ?> type="radio" id="annulation1" value="1" checked="" name="annulation" class="custom-control-input">
                                              <label class="custom-control-label" for="annulation1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['annulation'] == 0 ? print 'checked' : '' ?> type="radio" id="annulation2" value="0"  name="annulation" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['bloque'] == 1 ? print 'checked' : '' ?> type="radio" id="bloque1" value="1" checked="" name="bloque" class="custom-control-input">
                                              <label class="custom-control-label" for="bloque1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['bloque'] == 0 ? print 'checked' : '' ?> type="radio" id="bloque2" value="0" name="bloque" class="custom-control-input">
                                  ...
                                  <div class="form-group col-md-2">
                                      ...
                                      <div class="mb-4">
                                          <div style="display: inline-block;" class="custom-control custom-radio">
                                              <input <?php $oldvalue['etat'] == 1 ? print 'checked' : '' ?> type="radio" id="etat1" value="1" checked="" name="etat" class="custom-control-input">
                                              <label class="custom-control-label" for="etat1">Oui</label>
                                          </div>
                                          <div style="display: inline-block;margin-left: 20px" class="custom-control custom-radio">
                                              <input <?php $oldvalue['etat'] == 0 ? print 'checked' : '' ?> type="radio" id="etat2" value="0" name="etat" class="custom-control-input">
