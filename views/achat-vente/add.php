            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form id="addform" method="post" name="form_produit" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-1">
                                ...
                                <input name="cout_device" type="text" class="form-control" placeholder="Cout Device"
                                    id="cout_device" />
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="mb-4">
                                    <div style="display: inline-block;" class="custom-control custom-radio">
                                        <input type="radio" id="client1" value="1" checked="" name="bonsi"
                                            class="custom-control-input bon">
                                        <label class="custom-control-label" for="client1">Oui</label>
                                    </div>
                                    <div style="display: inline-block;margin-left: 20px"
                                        class="custom-control custom-radio">
                                        <input type="radio" id="client2" value="0" name="bonsi"
                                            class="custom-control-input bon">
                                                                    ...
                                                                    <div class="form-row">
                                                                        <div class="form-group   col-md-3">
                                                                            ...
                                                                            <input type="text" id="keywords"
                                                                                class="form-control"
                                                                                placeholder="Recherche par Num ou Nom"
                                                                                onkeyup="searchFilter()" />
                                                                        </div>
                                                                        <div class="form-group   col-md-2">
                                                                            <label> &nbsp;&nbsp;Emplacement : </label>
                                                                            <select id="depot" onchange="searchFilter()"
                                                                                class="form-control">
                                                                                <option value="0">Tous</option>
                                                                                <?php foreach ($data_depot as $depot): ?>
                                                                                    <option
                                                                                        value="<?php echo $depot->id; ?>">
                                                                                        <?php echo $depot->nom ?>
                                                                                    </option>
                                                                                <?php endforeach; ?>
                                                                            </select>
                                                                        ...
                                                                        <div class="form-group   col-md-2">
                                                                            ...
                                                                            <select id="fournisseur"
                                                                                ...
                                                                                <option value='-1' selected>Choisir un
                                                                                    fournisseur</option>
                                                                                <?php foreach ($fournisseurs as $fournisseur): ?>
                                                                                    <option
                                                                                        value="<?php echo $fournisseur->nom; ?>">
                                                                        ...
                                                                        <div class="form-group   col-md-3">
                                                                            ...
                                                                            <select id="categorie"
                                                                                onchange="searchFilter()"
                                                                                class="form-control select2-single">
                                                                                <option value="0">Choisir la catégorie
                                                                                </option>
                    ...
                    "><span id="el_nbr_count">0</span> produits ajoutés</div>
                                                    ...
                                                    <center>
                                                        <p id="barcode_footer" style="font-weight:900; font-size:16pt;">
                                                        </p>
                                                    </center>
                                                </div>
                                                <div class=""
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <div class="d-flex flex-row">
                                    <input style="max-width: 250px;" type="text" name="valunite" id="valunite"
                                        class="form-control " value="0">
                                    <input type="text" name="unite" id="unite" class="form-control ml-3"
                                        placeholder="Kg ou M²...">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                ...
                                <div class="d-flex flex-row">
                                    <input style="max-width: 250px;" type="text" name="unite2" id="unite2"
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <div class="d-flex flex-row">
                                    <input style="max-width: 250px;" type="text" name="qte_achetee" id="qte_achetee"
                                        class="form-control " value="0">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                ...
                                <div class="d-flex flex-row">
                                    <input style="max-width: 250px;" type="text" name="qte_vendue" id="qte_vendue"
                                        class="form-control " value="0">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                        ...
                        <div class="table-responsive">
                            <table class="table" cellpadding="0" cellspacing="0" id="box-table-a"
                                ...
                                <tbody id="detail_commande">
                                    ...
                                    foreach ($data as $ligne) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="badge badge-danger mb-2 delete"
                                                    data-id="<?php echo $ligne->id_detail; ?>"
                                                    style="color: white;cursor: pointer;" title="Supprimer"
