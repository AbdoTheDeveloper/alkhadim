      ...
      <div class="mb-2">
        ...
        <div class="float-sm-right text-zero">
          <button type="button" class="btn btn-primary btn-lg  mr-1 url notlink"
            data-url="vente_bon/add.php?bon=<?php echo $bon ?>">AJOUTER</button>
          <button type="button" class="btn btn-primary  url notlink" data-url="commande-vendeurs/index.php"> <i
                    ...
                    <td class="nowrap">
                      ...
                      <?php if (auth::user()['privilege'] == 'Admin') { ?>
                        ...
                        <a class="badge badge-info mb-2  " style="color: white;cursor: pointer;" title="Imprimmer"
                          href="<?php echo BASE_URL . "views/vente/facture.php?id=" . $ligne->id_vente; ?>&h=15"
                          target="_black">
                      ...
                      <?php } ?>
                      <a href="javascript:void(0)" data-toggle="modal" data-target="#modalMap"
                        class="badge badge-success btn-localisation"
                        data-localisation="<?php echo $ligne->localisation ?>" style="font-size:10pt;">
