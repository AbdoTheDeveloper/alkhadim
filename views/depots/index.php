                  ...
                  <tr>
                    ...
                    <td class="nowrap">
                      ...
                      foreach ($vendeurs as $row) {
                        if ($row->id == $ligne->id_vendeur) {
                          echo  $row->nom ;
                        } 
                      } ?>

                    </td>
                    <td> <?php echo $ligne->transporteur; ?></td>
                    <td>
                      <?php
                    ...
                    <td class="nowrap">
                      <?php if (auth::user()['privilege'] == 'Admin') { ?>
                        ...
                        <a class="badge badge-warning mb-2  url notlink" data-url="depots/update.php?id=<?php echo $ligne->id_depot_op; ?>" style="color: white;cursor: pointer;" title="Modifier" href="javascript:void(0)">
                        ...
                        <a class="badge badge-info mb-2  " style="color: white;cursor: pointer;" title="Imprimmer" href="<?php echo BASE_URL . "views/depots/facture.php?id=" . $ligne->id_depot_op . "&h=15?id=" . $ligne->id_vente; ?>&h=15" target="_black">
